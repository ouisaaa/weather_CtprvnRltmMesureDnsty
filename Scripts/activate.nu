...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\project\weather\weather_CtprvnRltmMesureDnsty'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\project\weather\weather_CtprvnRltmMesureDnsty\Scripts\deactivate.nu'
